        ...
        {loggedUser?.userType === "Comum" && (
          <>
            <div className={styles.paragraphs}>
              ...
              <p>Você pode acompanhar os mentores e mentorados da empresa</p>
            </div>
          </>
        )}
          ...
          <>
            <div className={styles.paragraphs}>
              ...
              <p>
                ...
                mentores e mentorados e gerenciar{" "}
                <strong>Trilhas e PDIs</strong>
              </p>
            </div>
            <div className={styles.btnGroup}>
              <Button
          ...
          <>
            <div className={styles.paragraphs}>
              <p>
                Para mantermos tudo <strong>organizado</strong> e{" "}
                <strong>caprichado</strong>, do jeitinho que a gente gosta, essa
                é a plataforma que iremos usar para você acompanhar seu
                desenvolvimento e metas durante seu período contratual.
              </p>
